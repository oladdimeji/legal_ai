...
import { Briefcase, Check, ChevronDown, FileText, Grid2X2, List, Plus, Search, Upload, X } from "lucide-react";
...
export default function MattersView({ matters, onRefresh, onOpenMatter }: Props) {
  ...
  const create = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (files.length || selectedLibrary.length) setStatus("Uploading sources...");
