...
export default function MatterWorkspaceView({ matterId, onBack, onMatterChange }: { matterId: string; onBack: () => void; onMatterChange: (matter: Case) => void }) {
