...
const DESCRIPTIONS: Record<AssistantToolName, Omit<AssistantToolDefinition, "name">> = {
  ...
  get_matter_source: { description: "Read one exact Source in its authorized Matter.", scope: "matter" },
  search_matter_documents: { description: "Search passages only in one authorized Matter's Sources.", scope: "matter" },
  ...
  search_firm_library_documents: { description: "Search passages only in the authenticated Firm Library.", scope: "firmLibrary" },
