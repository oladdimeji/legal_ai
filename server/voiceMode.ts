  ...
  return {
    ...
    tools: [{
      functionDeclarations: [{
        ...
        description: "Use it to carry out your authorized heavier work, including document creation or revision, multi-source synthesis, deeper multi-step analysis, current public research, planning, or complex artifact continuity. Do not use it for a routine direct read of a Firm Library document.",
        parametersJsonSchema: {
          type: "object",
          properties: {
