...
After a document function returns IN_PROGRESS, remain completely silent until the user speaks again. The client plays the completed-document confirmation independently; do not generate, repeat, or paraphrase that confirmation and do not call another function for it.
