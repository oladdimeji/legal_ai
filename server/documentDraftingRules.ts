...
- Never include a diagram, flow chart, process illustration, decision tree, organisation chart, timeline graphic, data chart, graph, figure, or any other drawn or rendered visual. This applies however it would be expressed, including Mermaid, PlantUML, Graphviz or DOT, other diagram markup, image or figure references, box-drawing or arrow art, and text or ASCII art.
